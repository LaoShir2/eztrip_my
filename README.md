...
flowchart LR
    ...
    classDef entity fill:#ffefdb,stroke:#d6a56c,stroke-width:1px;
    classDef store fill:#e2f0ff,stroke:#7ba7e1,stroke-width:1px;
    classDef process fill:#f8f8f8,stroke:#555,stroke-width:1px;
